...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rubocop/ruby2_2/version.rb", mod) }::Rubocop::Ruby22::Version::VERSION
  spec.authors = ["Peter H. Boling", "Annibelle Boling"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "🦾 Rules for Rubies: Rubocop + Standard + Betterlint + Gradual"
  spec.description = "🦾 Configure RuboCop + a bevy of friends to gradually lint Ruby 2.2 code"
  spec.homepage = "https://github.com/rubocop-lts/rubocop-ruby2_2"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://rubocop-ruby2-2.galtzo.com"
  ...
  # The 'git' gem is optional; rubocop-ruby2_2 falls back to shelling out to `git` if it is not present.
