...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/rubocop/ruby2_2/my_class.rb` -> `spec/rubocop/ruby2_2/my_class_spec.rb`.
...
[🧪build]: https://github.com/rubocop-lts/rubocop-ruby2_2/actions
