...
# kettle-jem:freeze
# To retain chunks of comments & code during rubocop-ruby2_2 templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# rubocop-ruby2_2 will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
...
SimpleCov.configure do
  ...
  skip "lib/rubocop/ruby2_2/railtie.rb"
  skip "lib/rubocop/ruby2_2/rakelib/rubocop_gradual.rake"
end
# To get coverage
